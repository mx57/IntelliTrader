...
DEFAULT_MANIFEST = Path(__file__).parent.parent / "agent_tasks.json"
...
def render_prompt(task: dict[str, Any]) -> str:
    ...
    return f"""You are working on IntelliTrader project (crypto trading bot).
You are using Magda Agent system to evolve this project.

Read first:
- magda_agent_system/AGENTS.md
- magda_agent_system/docs/jules_autonomous_loop.md
- magda_agent_system/docs/cognitive_architecture.md
- magda_agent_system/docs/codex_worker_plan.md
