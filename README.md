...
**RU: Внимание! В этот проект интегрирован агент Jules (Magda Agent System) для автономного развития и самоэволюции.**

IntelliTrader is a fully featured, highly configurable trading bot for cryptocurrency exchanges.
IntelliTrader — это полнофункциональный, высоконастраиваемый торговый бот для криптовалютных бирж.

### Краткое описание (RU)
* **Автономность**: Бот интегрирован с системой Jules, которая позволяет ему самостоятельно писать код, исправлять баги и добавлять новые функции.
* **Кроссплатформенность**: Поддержка Windows, Linux и MacOS.
* **Безопасность**: Включает механизмы проверки спреда и другие защитные функции.
* **Портативность**: Автоматическая сборка релизов через GitHub Actions.

Подробная техническая документация на английском языке приведена ниже.
