...
using IntelliTrader.Core.Models.Config;
    ...
    public class Application
    {
        ...
        public static void RegisterComponents(bool repos = true, bool queries = true, bool mappers = true)
        {
            if (Application.container == null)
            {
                ...
                var loadedAssemblies = AppDomain.CurrentDomain.GetAssemblies().Where(a => !string.IsNullOrEmpty(a.Location) && assemblyPattern.IsMatch(Path.GetFileName(a.Location)));
