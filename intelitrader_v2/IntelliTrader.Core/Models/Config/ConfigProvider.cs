...
namespace IntelliTrader.Core.Models.Config
{
    public class ConfigProvider : IConfigProvider
    {
        ...
        {
            IConfigurationRoot pathsConfig = GetPathsConfig(PATHS_CONFIG_PATH, changedPathsConfig =>
            {
        ...
        public string GetSectionJson(string sectionName)
        {
            try
            {
                ...
                var fullConfigPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, ROOT_CONFIG_DIR, configPath);
        ...
        {
            var fullConfigPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, ROOT_CONFIG_DIR);
        ...
        private IConfigurationRoot GetPathsConfig(string configPath, Action<IConfigurationRoot> onChange)
        {
            var fullConfigPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "IntelliTrader", ROOT_CONFIG_DIR);
